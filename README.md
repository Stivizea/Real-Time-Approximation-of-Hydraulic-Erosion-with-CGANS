...
you can increase the number of workers and batch size,  in the training section of the Gan_Model file, every worker uses approximately 1.96GB of VRAM), or you can use the weights of the model I trained for the article, 
...
![alt text](https://raw.githubusercontent.com/Stivizea/Real-Time-Approximation-of-Hydraulic-Erosion-with-CGANS/refs/heads/main/Figure_Recursive_Error_Analysis.png?raw=true)
