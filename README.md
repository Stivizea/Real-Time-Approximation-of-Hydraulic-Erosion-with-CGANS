...
you can increase the number of workers and batch size to reduce training time. Every worker uses approximately 1.96GB of VRAM), or you can use the weights of the model I trained for the article, 
