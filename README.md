...
Training time estimate: (8 Hours with 8GB of VRAM), or you can use the weights of the model I trained for the article, which can be found here 
https://drive.google.com/drive/folders/1r90NX1SYCDUVXGxiKFwSwcNfzQFxr--Z?usp=drive_link
